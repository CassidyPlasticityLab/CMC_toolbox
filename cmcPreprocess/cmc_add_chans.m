% This version is used for CMC

function [restored_data, restored_chanlocs] = add_chans(clean_data, chanlocs)
...
% loops through each channel and adds in the deleted ones
zeroed_lap = zeros(256);

j = 1;
for k=1:256
    if isempty(intersect(deleted_chans, k))
...
% Adapted from script by: Jennifer Wu and Ramesh Srinivasan
% Last debug: Jasper Mark, 11-08-2020
